...
#! <A bounded from below morphism in chain complexes category over category of left presentations of Q[x,y,z] with active lower bound 0>
IsWellDefined( phi );
#! true
phi_cofib := MorphismBetweenCofibrantModels( phi );
#! <A bounded from below morphism in chain complexes category over category of left presentations of Q[x,y,z] with active lower bound 0>
...
N_cofib := CofibrantModel( N );
#! <A bounded from below object in chain complexes category over category of left presentations of Q[x,y,z] with active lower bound 0>
SetUpperBound( M_cofib, 5 );
SetUpperBound( N_cofib, 5 );
phi_cofib;
#! <A bounded morphism in chain complexes category over category of left presentations of Q[x,y,z] with active lower bound 0 and active upper bound 5>
H := InternalHomOnObjects( M_cofib, N_cofib );
#! <A bounded object in chain complexes category over category of left presentations of Q[x,y,z] with active lower bound -4 and active upper bound 4>
